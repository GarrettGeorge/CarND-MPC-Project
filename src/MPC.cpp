...
// Defining "start" varibles making handling all the various 
// indices much easier
size_t x_start = 0;
 ...
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    for (unsigned int t = 0; t < N - 1; t++) {
      ...
      fg[0] += 100 * CppAD::pow(vars[a_start + t] * vars[cte_start + t], 2);
    }
    ...
    for (unsigned int t = 1; t < N; t++) {
      ...
      // To combat latency use previous actuator values
      if (t > 1) {
